	...
	public static void main(String args[])
	{
		...
		if (em != null)
		{
			...
			** of the terminal. */
			...
			MessageWindow mw = new MessageWindow("Fire Controller Status", WinPosX, WinPosY);
			...
			while ( !Done )
			{
				...
				for ( int i = 0; i < qlen; i++ )
				{
					...
					if ( Msg.GetMessageId() == 8 )
					{
						...
						if (Msg.GetMessage().equalsIgnoreCase("FireOff")) // broken window
						{
							FireState = false;
							mw.WriteMessage("Fire Off" );
