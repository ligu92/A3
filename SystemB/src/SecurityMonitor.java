...
class SecurityMonitor extends Thread {
	...
	public void run() {
		...
		int Delay = 1000; // The loop delay (0.5 seconds)
		...
		if (em != null) {
			...
			while (!Done) {
				...
				if (endTime - startTimeSprinkle > 2000) {
					mw.WriteMessage("Sprinkle controller has not repsonded for more than 2 seconds, please alert the Fire Department.");
					mw.WriteMessage("Alarm has not responded for:"
