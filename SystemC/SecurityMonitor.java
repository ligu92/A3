...
class SecurityMonitor extends Thread
{
	...
	public void run()
	{
		...
		if (em != null)
		{
			...
			ai = new Indicator ("DISARMED", mw.GetX(), mw.GetY()+mw.Height(), 3);
			...
			*********************************************************************/
			...
			while ( !Done )
			{
				...
				mw.WriteMessage("Alarms armed: " + alarms_armed + " Window break: " + window_break + 
					" Door break: " + door_break + " Motion detected: " + motion_detected);
				...
				if (endTime - startTime > 6000) {
					mw.WriteMessage("Alarm controller has not repsonded for more than 6 seconds, please alert the police.");
